...
private _getUrl = 'https://eschoolserver.herokuapp.com/api/pastpapers/';
private deleteurl  = 'https://eschoolserver.herokuapp.com/papers/papersdelete/';
...
uploadgrade06(uploadlink6){//grade 06 video
  this.http.post('https://eschoolserver.herokuapp.com/papers/uploadgrade06',uploadlink6).subscribe(res=>{
        console.log(res)
      })

 }
 uploadgrade07(uploadlink7){//grade 07 video link upload
  this.http.post('https://eschoolserver.herokuapp.com//papers/uploadgrade07',uploadlink7).subscribe(res=>{
        console.log(res)
      })

 }
 uploadgrade08(uploadlink8){//grade 08 video link upload
  this.http.post('https://eschoolserver.herokuapp.com/papers/uploadgrade08',uploadlink8).subscribe(res=>{
        console.log(res)
      })

 }
 uploadgrade09(uploadlink9){//grade 09 video link upload
  this.http.post('https://eschoolserver.herokuapp.com/papers/uploadgrade09',uploadlink9).subscribe(res=>{
        console.log(res)
      })

 }
 uploadgrade10(uploadlink10){//grade 10 video link upload
  this.http.post('https://eschoolserver.herokuapp.com/papers/uploadgrade10',uploadlink10).subscribe(res=>{
        console.log(res)
      })

 }
 uploadgrade11(uploadlink11){//grade 11 video link upload
  this.http.post('https://eschoolserver.herokuapp.com/papers/uploadgrade11',uploadlink11).subscribe(res=>{
        console.log(res)
      })

 }

 apiEndPoint  = 'https://eschoolserver.herokuapp.com/papers/';
 getLinks(){
 ...
 private _putUrl06 = 'https://eschoolserver.herokuapp.com/papers/grade06/';


 getGrade06(){
   return this.http.get<any>(this._putUrl06);
 }
 private _getUrl06 = 'https://eschoolserver.herokuapp.com/papers/grade06/';

 private _putUrl7 = 'https://eschoolserver.herokuapp.com/papers/grade07/';
 getGrade07(){
  return this.http.get<any>(this._putUrl7);
}
private _putUrl8 = 'https://eschoolserver.herokuapp.com/papers/grade08/';
 getGrade08(){
  return this.http.get<any>(this._putUrl8);
}
private _putUrl9 = 'https://eschoolserver.herokuapp.com/papers/grade09/';
 getGrade09(){
  return this.http.get<any>(this._putUrl9);
}
private _putUrl10 = 'https://eschoolserver.herokuapp.com/papers/grade10/';
 getGrade10(){
  return this.http.get<any>(this._putUrl10);
}
private _putUrl11 = 'https://eschoolserver.herokuapp.com/papers/grade11/';
 getGrade11(){
